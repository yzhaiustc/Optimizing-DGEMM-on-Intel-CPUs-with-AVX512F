...
void packing_b_24x8_edge_version2_k17(double *src,double *dst,int leading_dim,int dim_first,int dim_second){
...
void packing_a_24x8_edge_k17(double alpha,double *src, double *dst, int leading_dim, int dim_first, int dim_second){
